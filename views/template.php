...
<!--      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
              ...
              <li>
                ...
                <ul class="menu">
                  <li> start message 
                    <a href="#">
                      <div class="pull-left">
                        <img src="<?php echo $gravata; ?> class="img-circle" alt="User Image">
                      </div>
                      <h4>
                        Support Team
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="<?php echo $gravata; ?>" class="user-image" alt="User Image">
              <span class="hidden-xs"><?php echo Sessao::getSessionName(); ?></span>
            </a>
            <ul class="dropdown-menu">
               User image 
              <li class="user-header">
                ...
                <p>
                  <?php echo Sessao::getSessionName(); ?>
              ...
              <li class="user-footer">
                <div class="pull-left">
                  <a href="<?php echo BASE_URL ?>/usuarios/perfil" class="btn btn-default btn-flat">Perfil</a>
                </div>
           ...
           03/04/17 - Wesley     Comentário da Engranagem Barra lateral Direita    
          <li>
