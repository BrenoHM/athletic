...
<section class="content">
  ...
  <div class="box">
    <div class="box-header with-border">
      <h3 class="box-title">Inclua o parceiro</h3>
        ...
        <form action="" method="post" enctype="multipart/form-data">
            ...
            <div class="col-md-12">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="nomPar" class="form-control" name="nomPar" placeholder="Nome do Parceiro" value="" onclick="teste();">
                </div>
                
                <div class="form-group">
                    <label for="urlPar">Site do Parceiro</label>
                    <input type="text" id="urlPar" class="form-control" name="urlPar" placeholder="Site do Parceiro" value="">
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="submit" value="Salvar" name="frmParceiro" class="btn btn-primary" />
                </div>
